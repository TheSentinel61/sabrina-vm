...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision :file, source: '~/.ssh/id_rsa_honest',     destination: '/home/vagrant/.ssh/id_rsa_honest'
  config.vm.provision :file, source: '~/.ssh/id_rsa_honest.pub', destination: '/home/vagrant/.ssh/id_rsa_honest.pub'
...
sudo git clone git@github.com:unfunco/dotfiles.git deps/dotfiles
  PROVISION
end
